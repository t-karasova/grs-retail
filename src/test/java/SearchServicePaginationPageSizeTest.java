...
public class SearchServicePaginationPageSizeTest {
    ...
    // [START search_product_page_size]
    public static SearchResponse searchProducts_withPageSize(String query, int pageSize) throws IOException, InterruptedException {
        ...
        SearchRequest searchRequest = SearchRequest.newBuilder()
                ...
                .build();
        System.out.println("Search with pagination with page size, request: " + searchRequest);
        SearchResponse response = searchClient.search(searchRequest).getPage().getResponse();

        searchClient.shutdownNow();
        searchClient.awaitTermination(2, TimeUnit.SECONDS);
        System.out.println("Search with pagination with page size, response: " + response);
        return response;
    }
    ...
    public void search() throws IOException, InterruptedException {
        ...
        searchProducts_withPageSize("Nest_Maxi", 12);
